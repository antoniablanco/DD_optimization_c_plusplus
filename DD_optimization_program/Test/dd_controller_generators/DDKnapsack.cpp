...
Graph GetRelaxedDDKnapsack() {
    ...
    graph->add_new_layer();
    Node* node_9 = new Node(9, {0, 0});
    Arc* arc_6_9_op1 = new Arc(node_6, node_9, 0, "x_4");
    Arc* arc_6_9_op2 = new Arc(node_6, node_9, 1, "x_4");
