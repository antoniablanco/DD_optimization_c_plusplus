...
Graph GetDiferentOrderRestrictedDDIndependentSet() {
    Node* node_0 = new Node(0, {1, 2, 3, 4, 5});
    Graph* graph = new Graph(node_0);

    graph->add_new_layer();
    Node* node_2 = new Node(2, {2, 3, 4, 5});
    Arc* arc_0_2 = new Arc(node_0, node_2, 0, "x_1");
    node_0->add_out_arc(arc_0_2);
    node_2->add_in_arc(arc_0_2);
    graph->add_node(node_2);

    Node* node_1 = new Node(1, {4, 5});
    Arc* arc_0_1 = new Arc(node_0, node_1, 1, "x_1");
    node_0->add_out_arc(arc_0_1);
    node_1->add_in_arc(arc_0_1);
    graph->add_node(node_1);

    graph->add_new_layer();
    Node* node_3 = new Node(3, {5});
    Arc* arc_2_3 = new Arc(node_2, node_3, 1, "x_2");
    node_2->add_out_arc(arc_2_3);
    node_3->add_in_arc(arc_2_3);
    graph->add_node(node_3);

    Node* node_4 = new Node(4, {4, 5});
    Arc* arc_1_4 = new Arc(node_1, node_4, 0, "x_2");
    node_1->add_out_arc(arc_1_4);
    node_4->add_in_arc(arc_1_4);
    graph->add_node(node_4);
    ...
    graph->add_new_layer();
    Node* node_9 = new Node(9, {});
    Arc* arc_7_9_1 = new Arc(node_7, node_9, 0, "x_5");
    node_7->add_out_arc(arc_7_9_1);
    node_9->add_in_arc(arc_7_9_1);
    Arc* arc_7_9_2 = new Arc(node_7, node_9, 1, "x_5");
